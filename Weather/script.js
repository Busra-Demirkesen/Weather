...
const apiKey = '2c7550d29fc712533bd80cd449dec097';
...
function getWeatherIcon(id) {
  if (id <= 232) return 'thunderstorm.png' //thunderstorm
  if(id <= 321) return 'drizzle.png' // drizzle
  if(id <= 531) return 'rain.png' //rain
  if(id <= 622) return 'snow.png' //snow
  if(id <= 781) return 'atmosphere.png'  // atmosphere
